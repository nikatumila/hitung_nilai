            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">FORM INPUT DATA</h5>
                    <p class="text-center small">INPUT DATA MAHASISWA</p>
                  </div>

                  <form action="{{ route('post_create_mahasiswa') }}" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation" novalidate>
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <input type="number" name="presence" class="form-control" required>
                      <div class="invalid-feedback">Masukkan nilai absensi!</div>
                    </div>
                    <div class="col-12">
                      <label class="form-label">Nilai Praktek</label>
                      <input type="number" name="practice" class="form-control" required>
                      <div class="invalid-feedback">Masukkan nilai praktek!</div>
                    </div>
                    <div class="col-12">
                      <label class="form-label">Nilai UAS</label>
                      <input type="number" name="final_exam" class="form-control" required>
